/****************************************************************************
** Meta object code from reading C++ file 'FiltProxy.h'
**
...
#error "The header file 'FiltProxy.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CustomFilterProxyModel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CustomFilterProxyModel_t qt_meta_stringdata_CustomFilterProxyModel = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CustomFilterProxyModel[] = {
...
Q_CONSTINIT const QMetaObject CustomFilterProxyModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CustomFilterProxyModel.offsetsAndSizes,
    qt_meta_data_CustomFilterProxyModel,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CustomFilterProxyModel_t,
        // Q_OBJECT / Q_GADGET
